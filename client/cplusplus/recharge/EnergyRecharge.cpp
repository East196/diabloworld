...
void EnergyRecharge::scrollViewDidScroll(CCScrollView *view)
{
    
}

void EnergyRecharge::scrollViewDidZoom(CCScrollView *view)
{
    
}

void EnergyRecharge::tableCellTouched(CCTableView *table,CCTableViewCell *cell)
{
...
CCSize EnergyRecharge::cellSizeForTable(CCTableView *table)
{
...
unsigned int EnergyRecharge::numberOfCellsInTableView(CCTableView *table)
{
    return 15;
}
